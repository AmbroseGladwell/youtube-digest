...
html:not([dark]) #${OVERVIEW_BUTTON_ID}:hover {
  ...
  box-shadow: inset 0 1px 0 rgba(255,255,255,.9), inset 0 0 0 1px rgba(0,0,0,.07);
}
html:not([dark]) #${OVERVIEW_BUTTON_ID}[data-state="ready"] {
  background: linear-gradient(180deg, #fdf0ea 0%, #f8e2d8 100%);
  box-shadow: inset 0 1px 0 rgba(255,255,255,.9), inset 0 0 0 1px rgba(226,81,30,.36);
  color: #8f3210;
}
...
html[dark] #${OVERVIEW_BUTTON_ID}[data-state="ready"] {
  ...
  box-shadow: inset 0 1px 0 rgba(255,255,255,.06), inset 0 0 0 1px rgba(240,121,74,.4);
  color: #F0794A;
}
